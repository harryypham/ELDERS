    ...
    var t = {
            ...
            easeInElastic: function(t, n, e, r, a) {
                ...
                if (o < Math.abs(e)) {
                    ...
                    var u = i / (2 * Math.PI) * Math.asin(e / o);
            ...
            return t.forEach(function(a, u) {
                ...
                n.forEach(function(n) {
                    ...
                    if (o) {
                        ...
                        c.delay = (r.func(c.delay) ? c.delay(u, t.length) : c.delay) / c.speed,
                        c.duration = (r.func(c.duration) ? c.duration(u, t.length) : c.duration) / c.speed,
